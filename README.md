...
Below are some of the details of our API design, the complete API specification can be found in the above link:
...
- **Request Body:**
  ...
  - `phone_number` (string, example: '0800589657526')
- **Responses:**
